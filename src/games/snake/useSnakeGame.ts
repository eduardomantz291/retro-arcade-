// Hook principal do Snake.
// Mantém o loop do canvas, controles, colisões, power-ups e estado de partida.
...
import { drawSnakeRuntime } from "./engine/snakeRenderer";
